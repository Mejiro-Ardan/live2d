...
$(document).ready(() => {
    v = new Viewer('model');
    v.l2d.load('Azue Lane(JP)/mingshi', v);
});
...
class Viewer {
    constructor(basePath) {
        ...
        window.onresize = (event) => {
            ...
            let height = window.innerHeight - 20; // 修改为窗口的高度
            this.app.view.style.width = width + "px";
            this.app.view.style.height = height + "px";
            this.app.renderer.resize(width, height);
        ...
        this.app.view.addEventListener('mousemove', (event) => {
            ...
            // 将视线跟随鼠标的代码移出 if (this.isClick) 的判断语句
            if (this.model) {
                this.model.addParameterValueById("ParamEyeBallX", this.model.pointerX);
                this.model.addParameterValueById("ParamEyeBallY", -this.model.pointerY);
            }
        });
